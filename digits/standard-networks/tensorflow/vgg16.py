...
def build_model(params):
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected], 
        ...
        model = slim.repeat(_x, 2, slim.conv2d, 64, [3, 3], scope='conv1')
        ...
        model = slim.dropout(model, 0.6, is_training=params['is_training'], scope='do7')
        model = slim.fully_connected(model, params['nclasses'], activation_fn=None, scope='fcX8')
    def loss(y):
