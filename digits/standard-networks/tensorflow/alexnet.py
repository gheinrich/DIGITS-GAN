...
def build_model(params):
    ...
    assert params['input_shape'][0]==224, 'Input shape should be 224 pixels'
    assert params['input_shape'][1]==224, 'Input shape should be 224 pixels'
    ...
    weights = {
        ...
        'wc1': tf.get_variable('wc1', [11, 11, params['input_shape'][2], 96], initializer=tf.contrib.layers.xavier_initializer()),
        ...
        'out': tf.get_variable('wout', [4096, params['nclasses']], initializer=tf.contrib.layers.xavier_initializer()),
    }
